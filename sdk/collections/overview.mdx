...
<CardGroup cols={2}>
  ...
  <Card title="useIsEntityInCollection" href="/hooks/collections/use-is-entity-in-collection">
    Check whether a specific entity is saved in any of the user's collections.
  </Card>
</CardGroup>
