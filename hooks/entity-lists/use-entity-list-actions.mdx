...
<ResponseField name="fetchEntities" type="(listId: string, options: FetchEntitiesOptions) => Promise<Entity[] | null>">
  ...
  <Expandable title="FetchEntitiesOptions">
    ...
    <ResponseField name="sortBy" type="string" required>
    ...
    <ResponseField name="timeFrame" type="string">Time window filter.</ResponseField>
    <ResponseField name="include" type="string | string[]">Populate related data.</ResponseField>
  </Expandable>
</ResponseField>
