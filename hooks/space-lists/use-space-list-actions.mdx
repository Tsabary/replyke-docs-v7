...
<ResponseField name="fetchSpaces" type="(listId: string, params: FetchParams) => Promise<void>">
  Fetch spaces for the given list. Updates Redux state with the results.
</ResponseField>

<ResponseField name="createSpace" type="(listId: string, props: CreateSpaceProps) => Promise<Space>">
