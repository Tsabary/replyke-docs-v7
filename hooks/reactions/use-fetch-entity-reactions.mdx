...
<ResponseField name="data" type="Reaction[]">
  Array of reaction records. Each includes `id`, `userId`, `reactionType`, `targetId`, `targetType`, `createdAt`. The `user` field is populated when the user data is available.
</ResponseField>
