...
<ResponseField name="isEntityInCollection" type="(entityId: string, collectionId?: string) => Promise<{ saved: boolean; inSpecificCollection?: boolean; collections: Array<{ id: string; name: string }> }>">
